...
const generateBracketMatchHTML = (match, matchIndex) => {
...
const generateBracketMatchesHTML = (matches) => {
  let template = ''
...
const generateBracketHTML = (bracketID, bracketData) => {
...
const generateBracketsHTML = (genOrder, stages) => {
  let template = ''
...
const generateBrackets = (genOrder, stages, $brackets) => {
