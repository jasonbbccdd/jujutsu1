...
const generate32CardTeamHTML = (teamData) => `
...
const generate32CardTeamsHTML = (groupData) => {
  let template = ''
...
const generate32CardHTML = (groupID, groupData) => `
...
const generate32CardsHTML = (groups) => {
  let template = ''
